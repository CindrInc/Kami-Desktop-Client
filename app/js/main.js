$(function() {
	...
	let $results = $('#results');
	let elements = {
		$result: $('<a href=""><div class="row result"><div class="three columns"><img src=""></div><div class="nine columns"><h3 class="title"></h3><div class="genres"></div><h5 class="views"></h5><div class="otherNames"></div><p class="description"></p></div></div></a>'),
